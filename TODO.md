...
Let gralona have multiple repos to search in
    Organize cache for multiple repo usage (maybe have a tree-like structure) (COMPLETE)
        something like 
        debian
            stable
                main
        ...
        mint
            ...
    Allow gralona to select which distro's repo to access (COMPLETE)
    Give it something to detect when two repos might intersect (different versions of the same package, conflicting dependencies, etc) (almost complete)
